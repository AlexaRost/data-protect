...
namespace Shnorr
{
    public partial class Form1 : Form
    {
        ...
        private void оПрограммеToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            AB1.labelCompanyName.Text = "Название организации: НИУ МЭИ.";
            AB1.textBoxDescription.Text = "Программная реализация электронной цифровой подписи по протоколу Шнорра.";
            AB1.ShowDialog();
        }
